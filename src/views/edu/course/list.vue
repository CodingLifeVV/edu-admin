<template>
  <div class="app-container">
    ...
    <el-table :data="list" border fit highlight-current-row>
      ...
      <el-table-column prop="gmtCreate" label="添加时间" width="" />

      <el-table-column prop="viewCount" label="浏览数量" width="" />
...
export default {
  ...
  methods: {
    ...
    getList(page = 1) {
      this.page = page
      courseApi.listByPageCondition(this.page, this.limit, this.courseQuery)
        .then(response => {
